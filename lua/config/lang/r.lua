-- R language specific configuration
local M = {}
...
M.setup = function()
    ...
    vim.api.nvim_create_autocmd("FileType", {
        ...
        callback = function()
            vim.api.nvim_buf_set_keymap(0, 'n', '<leader>C', ':lua require("config.lang.r").toggle_comment_current_line()<CR>',
                { noremap = true, silent = true, desc = "Toggle comment" })
            vim.api.nvim_buf_set_keymap(0, 'v', '<leader>C', ':lua require("config.lang.r").toggle_comment_selected_lines()<CR>',
                { noremap = true, silent = true, desc = "Toggle comment" })
