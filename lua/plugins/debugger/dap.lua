...
-- Sets up nvim-dap with various adapters and configurations
-- Also sets up nvim-dap-ui and nvim-dap-virtual-text for better UI and inline variable display
-- Requires installation of external debuggers for specific languages (e.g., delve for Go, debugadapter for R, etc.)
-- Keybindings are provided for common debugging actions
-- Make sure to install the required plugins and debuggers for full functionality
...
return {
    {
        ...
        dependencies = {
            ...
            "nvim-neotest/nvim-nio",           -- Utility functions like async IO to Neovim core, used by dap-ui
            "williamboman/mason.nvim",         -- Package manager for LSP, DAP, linters, formatters
        },
        config = function()
            require("dap-go").setup()   -- Setup Go debugger
            local dap = require("dap")  -- Main nvim-dap module
            local ui = require("dapui") -- nvim-dap-ui module
            ...
            vim.keymap.set("n", "<leader>dp", function() dap.step_back() end, { desc = "Step Back" })
            ...
            vim.keymap.set("n", "<leader>?", function() ui.eval(nil, { enter = true }) end, { desc = "Evaluate expression in float" })
...

    {
        ...
        opts = {
            ...
            all_frames = false,
            virt_text_pos = 'eol',
            -- Custom display callback to avoid leaking secrets and trim long values
